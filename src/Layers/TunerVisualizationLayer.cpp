...
namespace PrecisionTuner::Layers
{
    ...
    void TunerVisualizationLayer::RenderCentDeviationMeter()
    {
        ...
        drawList->AddRectFilled(
            ImVec2(centerX - 2.0f, meterY), ImVec2(centerX + 2.0f, meterY + meterHeight), IM_COL32(255, 255, 255, 255));
        ...
        for (int cent : { -50, -40, -30, -20, -10, 10, 20, 30, 40, 50 })
        {
            ...
            drawList->AddRectFilled(
                ImVec2(x - 1.0f, tickY), ImVec2(x + 1.0f, tickY + tickHeight), IM_COL32(128, 128, 140, 255));
        }
    ...
    void TunerVisualizationLayer::RenderTargetStringIndicator()
    {
        ...
        std::string stringName =
            TuningPresets::GetStringName(targetStringIndex.value(), config.tuning.mode, config.tuning.referencePitch);
