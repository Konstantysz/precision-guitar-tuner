...
public:
     ...
     */
    [[nodiscard]] static std::optional<int> FindClosestString(TuningMode mode, float frequency,
     ...
     */
    [[nodiscard]] static std::string GetStringName(int stringIndex, TuningMode tuningMode,
                                                     float referencePitch = 440.0f);
